...
const ThankYou = () => {
  ...
  return <div className="bg-white">
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      ...
      <div className="mt-10 border-t border-zinc-200">
        <div className="mt-10 flex flex-auto flex-col">
          ...
          <p className="mt-2 text-sm text-zinc-600">
            We at iCase believe that a phone case doesn't only need to look good, but also last you for the years to come. 
      ...
      <div>
        <div className="grid grid-cols-2 py-10 text-sm">
          <div>
        ...
        <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
          ...
          <div>
            ...
            <p className="mt-2 text-zinc-700">Auspost, takes up to 48 hours</p>
          </div>
        </div>
      </div>
