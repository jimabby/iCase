...
const OrderReceivedEmail = ({shippingAddress, orderId, orderDate}: {shippingAddress: ShippingAddress, orderId: string, orderDate: string}) => {
  ...
  const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://i-case.vercel.app"
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              Delviery usually takes up to 48 hours.
            </Text>
            <Text style={{...global.text, marginTop: 24}}>
              If you have any questions regarding your order, please feel free to contact us with your order 
              nubmer and we're here to help.
            </Text>
          </Section>
          <Hr style={global.hr} />
